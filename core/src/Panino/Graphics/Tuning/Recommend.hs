...
recommendGraphicsTuning request currentOptions =
  ResolvedGraphicsTuning
    ...
    , resolvedGraphicsEvidence =
        ...
        , estimatedEvidence "hardwareTier" (renderTier effectiveTier)
        , estimatedEvidence "retinaPolicy" (renderRetina retinaPolicy)
        ]
...
renderTier :: GraphicsHardwareTier -> Text
renderTier tier =
  case tier of
...
renderRetina :: RetinaPolicy -> Text
renderRetina policy =
  case policy of
