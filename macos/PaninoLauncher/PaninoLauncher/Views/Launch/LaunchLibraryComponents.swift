...
struct LaunchLibraryHomeView: View {
    ...
    private func libraryShelf(showsPanel: Bool) -> some View {
...
private struct LaunchImmersiveBackground: View {
...
private struct LaunchImmersiveHeroSummary: View {
    let hasInstalledInstances: Bool
    let instance: GameInstance
...
private struct LaunchImmersiveControls: View {
    let hasInstalledInstances: Bool
    let primaryTitle: String
    let primaryDisabled: Bool
    let canCancel: Bool
...
private struct LaunchImmersiveContextShelf: View {
    let hasInstalledInstances: Bool
...
private struct LaunchLibraryHeroCard: View {
    ...
    var body: some View {
        Group {
            if showsPanel {
                GlassPanel(surfaceLevel: .elevatedPanel) { content }
            } else {
                content
            }
        }
...
private struct LaunchShelfModeSelector: View {
    @Binding var mode: LaunchShelfMode
